...
// Вызов функции для изменения фона при загрузке страницы
...
<main>
    ...
    <section>
        <h3>Ваши заказы</h3>
        <p>Всего заказов: <strong>-</strong></p>
        <p>Завершенные заказы: <strong>-</strong></p>
        <p>Заказы в процессе: <strong>-</strong></p>
    </section>
</main>
